...
class Transaction(db.Model):
    ...
    created_at = db.Column(db.DateTime, nullable=False, default=_utcnow, server_default=db.text("CURRENT_TIMESTAMP"))
    updated_at = db.Column(db.DateTime, nullable=False, default=_utcnow, onupdate=_utcnow, server_default=db.text("CURRENT_TIMESTAMP"))
